...
export default function Home() {
  return <main className="marketing-page">
    ...
    <section className="xray-hero shell continuity-marketing-hero" id="top"><div className="hero-grid-line line-a" /><div className="hero-grid-line line-b" /><div className="xray-kicker"><i /> DUEVIA · THE CONTINUITY LAYER FOR TOKENIZED ASSETS</div><div className="hero-layout"><div><h1>RWA continuity,<br />built into<br /><em>the asset.</em></h1><p className="hero-lede">Duevia is AI-powered recovery infrastructure for real-world assets. When a servicer goes dark, it reconstructs a verifiable operating state and coordinates a governance-controlled takeover on X Layer, so capital does not depend on one company, database, or dashboard.</p><div className="hero-buttons"><a className="button-dark" href="/app">Run the Continuity Agent <span>→</span></a><a className="button-quiet" href="/proof">Verify the live proof <span>↗</span></a></div></div><LiveOverview /></div><div className="hero-proof-bar"><div><b>Detect</b><span>Signed evidence + independent signals</span></div><div><b>Reconstruct</b><span>AI investigation + verifier</span></div><div><b>Protect</b><span>Deterministic X Layer policy</span></div><div><b>Take over</b><span>Governed successor handoff</span></div></div></section>

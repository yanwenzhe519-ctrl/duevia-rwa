...
export default function InfrastructureDeployer({ wallet, registryAddress }: { wallet: string; registryAddress: string }) {
  ...
  return <div className="infrastructure-panel">
    <div className="panel-title"><div><span>X LAYER INFRASTRUCTURE</span><h3>Autonomous continuity runtime</h3></div><b>{runtime.persistent && runtime.model === "model-grounded" ? "LIVE" : "PARTIAL"}</b></div>
